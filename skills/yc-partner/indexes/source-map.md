...
- Use for YC-specific rules, logistics, application guidance, and primary claims.
- Source notes:
  - `../resources/yc-website/apply-to-y-combinator-fall-2026.md` - official YC Fall 2026 application overview, deadline, interview process, batch logistics, and post-acceptance support.
  - `../resources/yc-website/application-video.md` - official YC founder application video instructions and examples.
  - `../resources/yc-website/early-decision-for-students.md` - official YC Early Decision page for students applying while still in school to reserve a future batch spot.
  - `../resources/yc-website/frequently-asked-questions.md` - official YC FAQ captured 2026-06-04; covers logistics, whether to apply, incorporating, late applications, and technical support.
  - `../resources/yc-website/what-happens-at-yc.md` - official YC overview of the YC program, funding, office hours, Bookface, community, Demo Day, brand, and hiring benefits.
...
- Folder: `../resources/rfs/`
- Use for official YC market and startup-opportunity areas from Requests for Startups.
- Source notes:
  - `../resources/rfs/` contains 83 official YC RFS sections captured from `https://www.ycombinator.com/rfs` on 2026-06-16, split into one processed Markdown file per section with filenames like `summer-2026-ai-for-low-pesticide-agriculture.md`.
...
- Folder: `../resources/application-form/`
- Use for official YC application form questions, exact prompt wording, and batch-specific application-question captures.
- Source notes:
  - `../resources/application-form/fall-2026-application-form-questions.md` - official YC Fall 2026 application and founder profile question capture.
...
- Use for short-form public social posts from YC-affiliated people and other relevant startup sources.
- Source notes:
...
- Folder: `../resources/founder-stories/`
- Use for stories from renowned YC startups, especially from their YC or early-company days.
- Source notes:
  - `../resources/founder-stories/amjad-masad-haya-odeh-replit-yc-application-story.md` - selected public excerpts from Amjad Masad and Haya Odeh's Replit YC application story: early skepticism, repeated rejections, Sam/PG recruiting, late application, interview, acceptance, and how YC helped Replit go bigger.
  - `../resources/founder-stories/john-collison-stripe-50-users-after-two-years.md` - founder story context about Stripe's slow early user growth and high-touch customer care.

## Dalton + Michael

- Folder: `../resources/dalton-michael/`
- Use for Dalton + Michael video transcripts.
- Source notes:
  - Contains 50 imported Dalton Caldwell and Michael Seibel transcript files from the parent corpus, numbered `007` through `058`.
  - Use `rg` in this folder for topics like cofounders, fundraising mistakes, doing things that do not scale, location/SF, startup experts, customer learning, goals, setbacks, and rejection.
...
- Folder: `../resources/external/`
- Use for optional framing only.
- Source notes:
  - `../resources/external/codeant-ai-yc-rejection-to-acceptance-story.md` - external unverified LinkedIn founder anecdote; use only as optional context for after-rejection morale and interview clarity around product, metrics, growth, and differentiation. The company/founder YC status was checked against the official YC directory; see `../resources/external/codeant-ai-yc-rejection-to-acceptance-story.md:15` and the caution at `../resources/external/codeant-ai-yc-rejection-to-acceptance-story.md:16`.
  - `../resources/external/kudu-yc-s22-rejection-email-slack-alternative-2022-06-27.md` - external public founder-posted YC rejection email for Kudu; use as one example of YC-style concern about competing with a deeply embedded incumbent through incremental product improvements. See the core concern at `../resources/external/kudu-yc-s22-rejection-email-slack-alternative-2022-06-27.md:31` and the source boundary at `../resources/external/kudu-yc-s22-rejection-email-slack-alternative-2022-06-27.md:17`.
  - `../resources/external/redacted-yc-post-interview-rejection-email-logistics-warehouse-marketplace.md` - public redacted screenshot capture of a personalized YC post-interview rejection email about warehouse outsourcing, customer quality, and multi-city scaling concerns. Use only as narrow context; never infer that another team with a similar idea would receive the same reasoning. See the source boundary at `../resources/external/redacted-yc-post-interview-rejection-email-logistics-warehouse-marketplace.md:19` and use boundary at `../resources/external/redacted-yc-post-interview-rejection-email-logistics-warehouse-marketplace.md:34`.
